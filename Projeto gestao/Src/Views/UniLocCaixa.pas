...
begin
  ...
  FrmCaixa.CBB_TIPO.Text        := dbgrdGridLocalizarCaixa.DataSource.DataSet.FieldByName('CIX_TIPO').AsString;
  FrmCaixa.CX_DESCRICAO.Text    := dbgrdGridLocalizarCaixa.DataSource.DataSet.FieldByName('CIX_DESCRICAO').AsString;
  FrmCaixa.CX_VALOR.Value       := dbgrdGridLocalizarCaixa.DataSource.DataSet.FieldByName('CIX_VALOR').AsFloat;
  Close;
end;
