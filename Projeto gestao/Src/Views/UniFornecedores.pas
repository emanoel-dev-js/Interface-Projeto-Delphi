...
type
  TFrmFornecedores = class(TForm)
    ...
    QryFornecedoresFOR_ID: TIntegerField;
    QryFornecedoresFOR_NOME: TIBStringField;
    QryFornecedoresFOR_ENDERECO: TIBStringField;
    QryFornecedoresFOR_TELEFONE: TIBStringField;
    QryFornecedoresFOR_EMAIL: TIBStringField;
    QryFornecedoresFOR_CNPJ: TIBStringField;
    QryFornecedoresFOR_ATIVO: TIBStringField;
    QryFornecedoresFOR_DATA_CAD: TDateField;
    edtFOR_ID: TEdit;
